...
![caption=Example of a series of LISP instructions (left). Database operation diagram (right). Pages 300 and 374, Artificial Intelligence, Patrick H. Winston (1977)](https://res.cloudinary.com/dcvnw6hvt/image/upload/v1768512499/elCronopio/Blog-posts/AI-tex-2_zp9uxc.png)

<QuoteAndAuthor quote="The problem of printing beautiful books had changed from a problem of metallurgy to a problem of optics and then to a problem of computer science. A problem of zeros and ones." author="Donald Knuth" source="Donald Knuth's Kyoto Prize Lecture (1996)" />
![caption=Example of equations, graphs, and diagrams that surprised Knuth in 1977. Pages 9 and 223, Artificial Intelligence, Patrick H. Winston (1977)](https://res.cloudinary.com/dcvnw6hvt/image/upload/v1768512500/elCronopio/Blog-posts/AI-tex-1_gwj8ne.png)
